...
makefile.conf: 
	coq_makefile -o makefile Utils/MathUtils.v OTP/OTPImpl.v OTP/OTPInterp.v OTP/OTPSpace.v Utils/PathUtils.v Utils/Vector.v CryptDB/cryptDB.v CryptDB/inc_dec.v CryptDB/insert_delete.v CryptDB/paillier_cryptosystem.v CryptDB/rsa_cryptosystem.v
